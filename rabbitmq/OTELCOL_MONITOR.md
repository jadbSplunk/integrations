...
To activate this monitor in the Splunk OpenTelemetry Collector, add the following to your
collector config:

```
exporters:  # The signalfx exporter is used to send metrics to the Splunk Observability Platform
  signalfx:
